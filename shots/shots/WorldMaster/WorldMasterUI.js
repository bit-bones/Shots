...
class WorldMasterUI {
    ...
    createCardDeckModals() {
        ...
        modModal.innerHTML = `
            <div style="background:#222;padding:24px 32px;border-radius:16px;max-width:520px;margin:60px auto;box-shadow:0 4px 32px #000b;position:relative;">
                <div style="font-size:1.1em;font-weight:bold;margin-bottom:12px;color:#65c6ff;">World Modifier Cards</div>
        ...
        pupModal.innerHTML = `
            <div style="background:#222;padding:24px 32px;border-radius:16px;max-width:520px;margin:60px auto;box-shadow:0 4px 32px #000b;position:relative;">
                <div style="font-size:1.1em;font-weight:bold;margin-bottom:12px;color:#ff5a5a;">Powerup Cards</div>
    ...
    showWorldModDeck() {
        ...
        for (const mod of allMods) {
            ...
            card.onclick = () => {
                this.worldMaster.toggleWorldMod(name, !enabled);
    ...
    showPowerupDeck() {
        ...
        for (const pup of allPups) {
            ...
            card.style.opacity = enabled ? '1' : '0.5';
            card.onclick = () => {
                this.worldMaster.togglePowerup(name, !enabled);
